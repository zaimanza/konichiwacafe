...
<!-- Navigation bar -->
	...
	<br>
	<a  href="#" onclick="updateAvailability()"><button class="primary-btn" style="border:none">Update Availability</button></a>             	
	<a  href="#" onclick="updateProfile()"><button class="primary-btn" style="border:none">Update Profile</button></a> 
