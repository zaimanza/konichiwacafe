								...
								<tr>
					        		...
					        		<c:forEach items="${listNew}" var="order">
						        		<tr>
						                    ...
						                    <td><a class="orderid" href="OrdersController?action=adminNewOrderdetails&i=<c:out value="${order.orderID}" />&custId=<c:out value="${order.custID}" />&RiderId=${order.riderID}">
						                    	<button class="updatebtn" style="border:none">View</button>
						                    </a></td>
						                   	<td><a href="RiderController?action=adminViewAvailableRiders&orderid=${order.orderID}"><button class="removebtn" style="border:none">Assign</button></a></td>    
						          		</tr>
					      			</c:forEach>
							</table>	
						</c:when>
