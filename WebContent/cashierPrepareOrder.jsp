					        		...
					        		<c:forEach items="${listPrepare}" var="order">
						        		<tr>
						                    ...
						                    <td><c:out value="${order.custID}" /></td>  
						                   	...
						                   	<td><a class="orderid" href="OrdersController?action=cashierPrepareOrderdetails&i=<c:out value="${order.orderID}" />&custId=<c:out value="${order.custID}" />&RiderId=${order.riderID}">
						                   		<button class="updatebtn" style="border:none">View</button>
						                   	</a></td>
						                   	<td><a href="OrdersController?action=cashierOrderPrepare&orderid=${order.orderID}"><button class="removebtn" style="border:none">Prepared</button></a></td>    
						          		</tr>
					      			</c:forEach>
							</table>	
						</c:when>
