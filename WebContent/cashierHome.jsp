...
<% int id = (Integer) request.getAttribute("cashierId");
...
<html>
	<head>
		...
		<meta charset="ISO-8859-1">
		<title>Cashier Home | Konichiwa Cafe</title>
	</head>
	<body class="example" class="center">
		...
		<script type="text/javascript">
			...
			if(localStorage.getItem("cashierID")!=null && localStorage.getItem("staffName")!=null ) 
			{
				jsStaffID2 = localStorage.getItem("cashierID");
				jsStaffName2 = localStorage.getItem("staffName");
			} 
			
			else 
			{
				localStorage.setItem("cashierID", jsStaffID);
