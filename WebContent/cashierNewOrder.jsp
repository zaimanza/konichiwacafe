							...
							<table class="address">	
								<tr>
					        		...
					        		<c:forEach items="${listNew}" var="order">
						        		<tr>
						            		<td><a class="orderid" href="OrdersController?action=cashierNewOrderdetails&i=<c:out value="${order.orderID}" />"><c:out value="${order.orderID}" /></a></td>        
						                    <td><c:out value="${order.orderDate}" /></td>  
						                    <td><c:out value="${order.getDeliveryAddress()}" /></td>  
						                    <td><c:out value="${order.custID}" /></td>   
						                   	<td><a href="RiderController?action=cashierViewAvailableRiders&orderid=${order.orderID}"><button class="removebtn" style="border:none">Assign Rider</button></a></td>    
						          		</tr>
					      			</c:forEach>
							</table>	
						</c:when>
