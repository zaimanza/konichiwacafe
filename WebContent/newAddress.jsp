					...
					<div class="register-form">
						...
						<form name="newaddress" action="AddressController?action=new" method="post" onsubmit="return validate()">
							...
							<div class="group-input">
								...
								<input type="text" name="addr1" placeholder="Address Line 1 / Street">
							</div>
							<div class="group-input">
								<label for="city">City</label>
								<input type="text" name="addr2" placeholder="City">								
							</div>
							<div class="group-input">
								<label for="postcode">Postcode</label>
								<input type="text" name="addr3" placeholder="Postcode">							
							</div>
							<div class="group-input">
								<label for="state">State</label>
								<input type="text" name="addr4" placeholder="State">							
							</div>
							<button type="submit" class="site-btn register-btn">Add</button>
						</form>
						<div class="switch-login">
							<a href="AddressController?action=viewAddress&i=<%= session.getAttribute("custid") %>" class="or-login">Address List</a>
						</div>
					</div>
				</div>
			</div>
