		...
		<tr>
			...
			<c:forEach items="${item}" var="item">
				<tr>
					...
					<td align="center">RM <fmt:formatNumber type="number" maxFractionDigits="2" minFractionDigits="2" value="${item.price}"/></td>
					...
					<td><img src="data:image/jpg;base64,${item.image}" width="150"/></td>
					
					<td width="20%" align="center">
						<a href="ItemController?action=edit&id=<c:out value="${item.itemid}" />" ><button class="updatebtn" style="border:none;">Update</button></a>
						<br><br>
						<form name="deleteItem" method="post" action="ItemController?action=deleteItem" onsubmit="return ask()">
							<button class="deletebtn" name="itemID" value="${item.itemid}" style="border:none">Delete</button>
						</form>
					</td>
				</tr>
			</c:forEach>
